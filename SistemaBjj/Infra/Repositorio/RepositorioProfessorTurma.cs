...
namespace Infra.Repositorio
{
    public class RepositorioProfessorTurma : RepositorioGenerics<ProfessorTurma>, InterfaceProfessorTurma
    {
        ...
        public async Task<bool> RemoverProfessorTurma(int professorID)
        {
            using (var banco = new ContextBase(_OptionsBuilder))
            {
                var professorTurmas = banco.professorTurmas.Where(pt => pt.ProfessorID.Equals(professorID));
                banco.professorTurmas.RemoveRange(professorTurmas);
