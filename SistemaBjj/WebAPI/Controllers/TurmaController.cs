...
namespace WebAPI.Controllers
{
    ...
    public class TurmaController : ControllerBase
    {
        ...
        [HttpGet("/api/ListarAlunosTurma")]
        [Produces("application/json")]
        public async Task<Object> ListarAlunosTurma(int turmaID)
        {
            return await _interfaceAlunoTurma.ListarTodosAlunosTurma(turmaID);
        }
        ...
        [Produces("application/json")]
        public async Task<Object> RemoverProfessorTurma(int professorID)
        {
            return await _interfaceProfessorTurma.RemoverProfessorTurma(professorID);
        }
